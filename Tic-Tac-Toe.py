...
def rotate_180_right():
    ...
    motor_right.run_timed(time_sp=4199.368955, speed_sp=-100, stop_action='hold')
    motor_left.run_timed(time_sp=4199.368955, speed_sp=100, stop_action='hold')
...
def rotate_90_left():
    ...
    motor_right.run_timed(time_sp=4207.207128, speed_sp=100, stop_action='hold')
    # wait till the motor has stopped
    motor_right.wait_while('running')
    sleep(0.3)
...
def rotate_90_right():
    ...
    motor_left.run_timed(time_sp=4207.207128, speed_sp=100, stop_action='hold')
    # wait till the motor has stopped
    motor_left.wait_while('running')
    sleep(0.3)
...
def rotate_90_left_alt():
    # move motor left for 90 deg rotation
    motor_right.run_timed(time_sp=2095.684478, speed_sp=100, stop_action='hold')
    motor_left.run_timed(time_sp=2095.684478, speed_sp=-100, stop_action='hold')
    # wait till the motor has stopped
    motor_left.wait_while('running')
    motor_right.wait_while('running')
    sleep(0.3)
